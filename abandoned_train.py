...
This file is for when the pc crashed when it reaches Stage 2.
"""
import os
import numpy as np
...
def _main():
    ...
    # manually just add the folder instead of using the method
    # create_lgos_dir
    log_dir = 'logs/2/'
    print(log_dir)
    ...
    if is_tiny_version:
        ...
        ## if it's abadoned you wanted to add in your stage 1 results
        ## or train from the most recent h5 it saved.
        ## either 'logs/2/train_weights_stage_1.h5' or
        ## a file like 'logs/2/ep054-loss15.131-val_loss14.878.h5'
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='logs/2/ep054-loss15.131-val_loss14.878.h5') # make sure you know what you freeze
    ...
    ## because we are only focussed on stage two set to false.
    # if True:
    if False:
